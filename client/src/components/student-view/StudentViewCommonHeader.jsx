...
const StudentDashboard = () => {
  return (
    ...
    <Sidebar />
      ...
      <main className="ml-64 flex-1 overflow-y-auto px-6 py-10">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <Link to="/abop" className="flex items-center space-x-3 bg-white p-3 rounded-lg shadow hover:shadow-md transition">
