...
const AdminDashboard = () => {
  ...
  const handleNotificationSubmit = async (newNotification) => {
    ...
    try {
      ...
      setResponseMessage("Notification added successfully!"); // Success message
      setAddNotificationVisible(false);
    } catch (error) {
      console.error("Error creating announcement:", error);
      setResponseMessage("Failed to add notification."); // Error message
    } finally {
  ...
  return (
    <div className="admin-dashboard">
      ...
      {responseMessage && <div className="response-message">{responseMessage}</div>} {/* Response message */}
...
const AddNotificationPage = ({ onSubmit, onCancel, editingNotification }) => {
  const [formData, setFormData] = useState(
    editingNotification || {
      ...
      image: null,
      type: "none",
      targetAudience: "student", // Default to 'student'
    }
  );
        ...
        <div>
          ...
          <label>
            <input
              ...
              name="targetAudience"
              value="teacher"
              checked={formData.targetAudience === "teacher"}
              onChange={handleInputChange}
            />
            Teacher
          </label>
